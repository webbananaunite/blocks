#
#  Be sure to run `pod spec lint blocks.podspec' to ensure this is a
...
It is depend on overlayNetwork library.
  ...
  spec.homepage     = "https://github.com/webbananaunite/blocks"
  ...
  spec.author             = { "WEB BANANA UNITE Tokyo-Yokohama LPC." => "mizu@webbanana.org" }
  # Or just: spec.author    = "webbananaunite"
  # spec.authors            = { "webbananaunite" => "mizu@webbanana.org" }
  # spec.social_media_url   = "https://twitter.com/webbananaunite"
  ...
  spec.source_files  = "blocks", "blocks/**/*.{h,m}"
  spec.exclude_files = "blocks/Exclude"
